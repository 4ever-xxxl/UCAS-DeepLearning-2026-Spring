...
def build():
    ...
    add_textbox(slide, 1.2, 4.0, 31, 0.8, status_text, font_size=16, bold=True, color=WHITE, alignment=PP_ALIGN.CENTER)
    ...
    add_table(
        ...
        [
            ...
            ["Val PPL", f"{epoch_1['val_perplexity']:.1f}", "129.8", "103.5", "93.5", "85.3", "82.8", "82.7", "82.6"],
        ],
        col_widths=[3] + [2.8] * 8,
        font_size=10,
    )
    ...
    if curves_path.exists():
        add_textbox(
            ...
            31,
            0.6,
            "训练曲线（Loss / Perplexity / Accuracy / Learning Rate）",
            font_size=14,
            bold=True,
            color=PRIMARY,
        )
